...
class ModelReviewer extends CI_Model{
	...
	public function get_list_ta(){
		$this ->db ->select('tmst_ta.*,tmst_mahasiswa.*,tmst_dosen.nama as nama_dosen');
	...
	public function get_list_ta_edit($id){
		$this ->db ->select('tmst_ta.*,tmst_mahasiswa.*,tmst_dosen.nama as nama_dosen,tmst_dosen.nip');
		$this->db->join('tmst_mahasiswa','tmst_mahasiswa.nim = tmst_ta.tmst_mahasiswa_nim');
		$this->db->join('tmst_dosen','tmst_dosen.nip = tmst_ta.tmst_dosen_nip');
		$this ->db ->from('tmst_ta');
		$this->db->where('id',$id);
