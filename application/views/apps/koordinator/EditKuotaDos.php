    ...
    <div class="col-sm-12">
        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                ...
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 250px;">Edit Kuota
                    </th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo anchor('Koordinator/tampildiformkuota/'.$data->nip,'Edit','class="btn btn-warning btn-bordered waves-effect w-md waves-light"') ?></td>
